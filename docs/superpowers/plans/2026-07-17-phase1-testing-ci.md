...
- [x] **Step 4: Remove the placeholder and commit**
...
- [x] **Step 1: Make `DBT_PROJECT_PATH`/`DBT_EXECUTABLE` portable in `dags/dbt_pipeline_dag.py`**
...
- [x] **Step 2: Parameterize `dbt_project/profiles.yml` host/port**
...
- [x] **Step 3: Create `tests/conftest.py`**
...
- [x] **Step 4: Create `tests/test_dag_integrity.py`**
...
- [x] **Step 1: Extract `_ingest_olist_files` in `dags/dbt_pipeline_dag.py`**
...
- [x] **Step 2: Create the 9 Olist CI sample fixture CSVs**
...
- [x] **Step 3: Create `tests/test_ingest_olist.py`**
...
- [x] **Step 1: Extract `_extract_descriptions_from_manifest` in `dags/rag_index_dag.py`**
...
- [x] **Step 1b: Extract `_ensure_catalog_embeddings_schema` in `dags/rag_index_dag.py`**
...
- [x] **Step 2: Create `tests/test_rag_index.py`**
...
- [x] **Step 1: Add column tests to `mart_customer_orders_masked` in `dbt_project/models/marts/schema.yml`**
...
- [x] **Step 2: Create `dbt_project/tests/assert_customer_orders_subtotals_valid.sql`**
...
- [x] **Step 3: Create `dbt_project/tests/assert_olist_customer_orders_subtotals_valid.sql`**
...
- [x] **Step 4: Run dbt to verify the new tests pass against current data**
...
- [x] **Step 1: Create `tests/test_dbt_build.py`**
...
- [x] **Step 3: Run the full test suite together to confirm no cross-test interference**
...
- [x] **Step 2: Push the branch and verify the workflow runs green on GitHub**
